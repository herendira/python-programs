...
# import math
# square=float(input("What is the length of a side of the square in centemeters? "))
# areaCentimeter=(square*square)
# areaMeter=(square*square)/10000
# print(f"The Area of the square by centimeters is: {areaCentimeter}")
# print(f"The Area of the square by meters is: {areaMeter}")
